...
The clusteranalysis *Code of Conduct* sets the rules for the behavior of
every member in the clusteranalysis community so that everyone can
...
clusteranalysis is part of an engaged and respectful community made up of people from all
...
avoid, you will help us make clusteranalysis a welcoming and productive community.
...
7. **When we disagree, try to understand why**. Disagreements, both social and
   technical, happen all the time and clusteranalysis is no exception. It is important
   that we resolve disagreements and differing views constructively. Remember
   that we’re different. The strength of clusteranalysis comes from its varied community
...
reported by contacting the project team at 'ralmadamonter@ucsd.edu'. The project team will

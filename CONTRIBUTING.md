...
We welcome all contributions to clusteranalysis!

Contributions can take many forms, such as:

* sharing bug reports or feature requests through the [Issue Tracker](https://github.com/richiam16/clusteranalysis/issues)
...
The second two options both involve making a [pull request](https://github.com/richiam16/clusteranalysis/pulls) .

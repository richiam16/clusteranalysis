...
import clusterkit  # noqa



# -- Project information -----------------------------------------------------

project = "clusteranalysis"
copyright = (
    "2024, Ricardo Almada Monter. "
...
htmlhelp_basename = "clusteranalysisdoc"
...
latex_documents = [
    (master_doc, "clusteranalysis.tex", "clusteranalysis Documentation",
     "clusteranalysis", "manual"),
]
...
man_pages = [
    (master_doc, "clusteranalysis", "clusteranalysis Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "clusteranalysis", "clusteranalysis Documentation",
     author, "clusteranalysis", "A MDAnlysis MDkit for making cluster analysis of trajectories usign MDanalisys",
     "Miscellaneous"),
]
